...
public class ModRecipes {
    ...
    public static final RecipeBookCategory COOKING_SUSPICIOUS_STEW = Registry.register(BuiltInRegistries.RECIPE_BOOK_CATEGORY, Identifier.fromNamespaceAndPath("calcium", "cooking_suspicious_stew"), new RecipeBookCategory());
