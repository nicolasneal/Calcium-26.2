...
public class Cracking {
    ...
    private static final Map<Block, Block> CRACKED_BLOCKS = new ImmutableMap.Builder<Block, Block>()
        ...
        .put(ModBlocks.BLOODSTONE_BRICKS, ModBlocks.CRACKED_BLOODSTONE_BRICKS)
        .put(ModBlocks.BLOODSTONE_BRICK_STAIRS, ModBlocks.CRACKED_BLOODSTONE_BRICK_STAIRS)
        .put(ModBlocks.BLOODSTONE_BRICK_SLAB, ModBlocks.CRACKED_BLOODSTONE_BRICK_SLAB)
        .put(ModBlocks.BLOODSTONE_BRICK_WALL, ModBlocks.CRACKED_BLOODSTONE_BRICK_WALL)
        ...
        .put(ModBlocks.SOULSLATE_BRICKS, ModBlocks.CRACKED_SOULSLATE_BRICKS)
        .put(ModBlocks.SOULSLATE_BRICK_STAIRS, ModBlocks.CRACKED_SOULSLATE_BRICK_STAIRS)
        .put(ModBlocks.SOULSLATE_BRICK_SLAB, ModBlocks.CRACKED_SOULSLATE_BRICK_SLAB)
        .put(ModBlocks.SOULSLATE_BRICK_WALL, ModBlocks.CRACKED_SOULSLATE_BRICK_WALL)
        .put(ModBlocks.MIRESTONE_BRICKS, ModBlocks.CRACKED_MIRESTONE_BRICKS)
        .put(ModBlocks.MIRESTONE_BRICK_STAIRS, ModBlocks.CRACKED_MIRESTONE_BRICK_STAIRS)
        .put(ModBlocks.MIRESTONE_BRICK_SLAB, ModBlocks.CRACKED_MIRESTONE_BRICK_SLAB)
        .put(ModBlocks.MIRESTONE_BRICK_WALL, ModBlocks.CRACKED_MIRESTONE_BRICK_WALL)
