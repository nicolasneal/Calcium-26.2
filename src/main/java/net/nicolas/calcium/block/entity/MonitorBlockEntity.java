package net.nicolas.calcium.block.entity;
...
import net.nicolas.calcium.block.custom.MonitorBlock;
...
public class MonitorBlockEntity extends ItemDisplayBlockEntity {
