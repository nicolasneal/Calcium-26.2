...
public class ModBlocks {
    ...
    public static final Block CRACKED_DEEPSLATE_TILE_WALL = register("cracked_deepslate_tile_wall", WallBlock::new, BlockBehaviour.Properties.of().sound(SoundType.DEEPSLATE_TILES).mapColor(MapColor.DEEPSLATE).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(3.0F, 6.0F), true);
    ...
    public static final Block CRACKED_PACKED_MUD_BRICKS = register("cracked_packed_mud_bricks", Block::new, BlockBehaviour.Properties.of().sound(SoundType.MUD_BRICKS).mapColor(MapColor.DIRT).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(1.5F, 3.0F), true);
    public static final Block CRACKED_PACKED_MUD_BRICK_STAIRS = register("cracked_packed_mud_brick_stairs", settings -> new StairBlock(ModBlocks.CRACKED_PACKED_MUD_BRICKS.defaultBlockState(), settings), BlockBehaviour.Properties.of().sound(SoundType.MUD_BRICKS).mapColor(MapColor.DIRT).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(1.5F, 3.0F), true);
    public static final Block CRACKED_PACKED_MUD_BRICK_SLAB = register("cracked_packed_mud_brick_slab", SlabBlock::new, BlockBehaviour.Properties.of().sound(SoundType.MUD_BRICKS).mapColor(MapColor.DIRT).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(1.5F, 3.0F), true);
    public static final Block CRACKED_PACKED_MUD_BRICK_WALL = register("cracked_packed_mud_brick_wall", WallBlock::new, BlockBehaviour.Properties.of().sound(SoundType.MUD_BRICKS).mapColor(MapColor.DIRT).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(1.5F, 3.0F), true);
    ...
    public static final Block CRACKED_END_STONE_BRICKS = register("cracked_end_stone_bricks", Block::new, BlockBehaviour.Properties.of().sound(ModSounds.END_STONE).mapColor(MapColor.SAND).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(3.0F, 9.0F), true);
    public static final Block CRACKED_END_STONE_BRICK_STAIRS = register("cracked_end_stone_brick_stairs", settings -> new StairBlock(ModBlocks.CRACKED_END_STONE_BRICKS.defaultBlockState(), settings), BlockBehaviour.Properties.of().sound(ModSounds.END_STONE).mapColor(MapColor.SAND).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(3.0F, 9.0F), true);
