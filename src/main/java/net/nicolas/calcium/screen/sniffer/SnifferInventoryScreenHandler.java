package net.nicolas.calcium.screen.sniffer;
...
public class SnifferInventoryScreenHandler extends AbstractContainerMenu {
    ...
    public SnifferInventoryScreenHandler(int containerId, Inventory inventory, boolean hasChest) {
        this(containerId, inventory, null, hasChest);
    }

    public SnifferInventoryScreenHandler(int containerId, Inventory inventory, @Nullable Sniffer sniffer) {
        this(containerId, inventory, sniffer, sniffer != null && ((SnifferChestAccess) sniffer).calcium$hasChest());
    }

    private SnifferInventoryScreenHandler(int containerId, Inventory inventory, @Nullable Sniffer sniffer, boolean hasChest) {
