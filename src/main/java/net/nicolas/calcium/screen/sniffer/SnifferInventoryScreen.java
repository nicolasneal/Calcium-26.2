...
public class SnifferInventoryScreen extends AbstractContainerScreen<SnifferInventoryScreenHandler> {
    ...
    public SnifferInventoryScreen(SnifferInventoryScreenHandler menu, Inventory inventory, Component title) {
    ...
    @Override public void extractBackground(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.getMenu().hasChest()) {
            graphics.blitSprite(RenderPipelines.GUI_TEXTURED, CHEST_SLOTS_SPRITE, 90, 54, 0, 0, xo + 79, yo + 16, SnifferInventoryScreenHandler.CHEST_COLUMNS * 18, SnifferInventoryScreenHandler.CHEST_ROWS * 18);
        }
